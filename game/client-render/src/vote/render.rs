...
pub struct VoteRenderPipe<'a> {
    ...
    pub expects_player_vote_miniscreen: bool,
}
...
impl VoteRender {
    ...
    pub fn render(&mut self, pipe: &mut VoteRenderPipe) -> Option<Rect> {
        ...
        let mut user_data = UserData {
            ...
            map_vote_thumbnail_container: pipe.map_vote_thumbnail_container,
            render_tee: pipe.tee_render,

            vote_data: pipe.vote_data,
            player_vote_rect: &mut player_rect,
            player_vote_miniscreen: pipe.expects_player_vote_miniscreen,
        };
