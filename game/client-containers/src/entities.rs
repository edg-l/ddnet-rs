...
impl LoadEntities {
    pub fn new(
        ...
        Ok(Self {
            ...
            .img,
            speedup: load_file_part_and_convert_3d_and_upload(
                graphics_mt,
                runtime_thread_pool,
                &files,
                default_files,
    ...
    fn load(
        ...
        match files {
            ...
            ContainerLoadedItem::SingleFile(file) => {
                ...
                files.insert("ddnet.png".into(), file);
                let files = ContainerLoadedItemDir::new(files);
                Self::new(
                    graphics_mt,
                    files,
                    default_files,
    ...
    fn convert(
        ...
        Entities {
            physics: self
                ...
                .collect(),
            speedup: Self::load_file_into_texture(
                texture_handle,
                self.speedup,
                &self.entities_name,
            ),
